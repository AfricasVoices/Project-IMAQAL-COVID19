...
if __name__ == "__main__":
    ...
    if pipeline_configuration.drive_upload is not None:
        ...
        log.info("Uploading automated analysis csv files to Drive...")
        ...
        log.info("Uploading production CSV file to Drive...")
        ...
        log.info("Uploading messages CSV file to Drive...")
        ...
        log.info("Uploading individual CSV file to Drive...")
